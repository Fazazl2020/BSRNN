"""
Mamba Building Blocks for Ablation 2: Dual-Path BiMamba

This file contains all Mamba components needed for Ablation 2,
including cross-band Mamba modeling.
"""

...
class TrainingConfig:
    ...
    save_model_dir = '/ghome/fewahab/Sun-Models/Ab-6/M3/saved_model'  # Saves in current directory
...
class Trainer:
    def __init__(self, train_ds, test_ds):
        ...
        # Create model - Ablation 3 (MEMORY-OPTIMIZED)
        self.model = MBS_Net(
            num_channel=128,
        ...
        logging.info("Ablation 3: Full BS-BiMamba with Adaptive Decoder (MEMORY-OPTIMIZED)")
        ...
        logging.info(f"Expected: ~2.3M params")
...
def main():
    print("=" * 70)
    print("ABLATION 3: Full BS-BiMamba with Adaptive Decoder")
    print("=" * 70)
    print(f"Expected PESQ: 3.2-3.5 (BEST)")
    print(f"Expected Parameters: ~2.82M (MOST EFFICIENT)")
    print("=" * 70)
